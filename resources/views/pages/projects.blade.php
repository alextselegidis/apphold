...
@section('content')
    ...
    <div class="d-flex flex-column-reverse flex-lg-row">
        ...
        <div class="flex-grow-1 mb-5 mb-lg-0">
            ...
            <form action="{{route('projects')}}" method="GET" class="mb-3">
                @csrf
                @method('GET')
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        <th style="width: 10%">
                            <a href="{{ route('projects', ['sort' => 'id', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">
                                {!! sort_link('id', __('id')) !!}
                            </a>
                        </th>
                        <th style="width: 20%">
                            <a href="{{ route('projects', ['sort' => 'name', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}">
                    ...
                    @foreach($projects as $project)
                        <tr onclick="window.location='{{route('projects.show', $project->id)}}'" style="cursor: pointer;">
                            <td>
                                @include('shared.id-value', ['value' => $project->id])
                            </td>
                            <td>
                                {{$project->name}}
                            </td>
                            ...
                            <td class="text-end">
                                <div class="dropdown" onclick="event.stopPropagation();">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a href="{{route('projects.edit', ['project' => $project->id])}}" class="dropdown-item">
                                                {{__('edit')}}
                                            </a>
                                        </li>
                                        <li>
